...
if ($page_accueil && $page_accueil->ID > 0) {
	...
	/**
	 * Les grands accès directs
	 */
    if (function_exists("register_field_group")) {
        register_field_group(array(
            'key' => 'les-grands-acces-direct',
            'title' => 'Les grands accès direct',
            'fields' => array (
                array (
                    'key' => 'field_55ae2734e575f',
                    'label' => 'Accès direct 1',
                    'name' => 'citeo_big_access_1',
                    'type' => 'relationship',
                    'instructions' => '',
                    'required' => 0,
                    'conditional_logic' => 0,
                ...
                array (
                    'key' => 'field_55ae27c4e5760',
                    'label' => 'Accès direct 2',
                    'name' => 'citeo_big_access_2',
                    'type' => 'relationship',
                    'instructions' => '',
                    'required' => 0,
                    'conditional_logic' => 0,
    ...
    if( function_exists('register_field_group') ):
        ...
        register_field_group(array (
            ...
            'fields' => array (
                array (
                    'key' => 'field_55ae4576ac4b0',
                    'label' => 'Les partenaires',
                    'name' => 'citeo_partenaires',
                    'type' => 'repeater',
                    'instructions' => '',
                    'required' => 0,
                    'conditional_logic' => 0,
                    ...
                    'sub_fields' => array (
                        array (
                            'key' => 'field_55ae45edac4b1',
                            'label' => 'Nom',
                            'name' => 'citeo_partenaire_name',
                            'type' => 'text',
                            'instructions' => '',
                            'required' => 0,
                            'conditional_logic' => 0,
                        ...
                        array (
                            'key' => 'field_55cda47a0f3c7',
                            'label' => 'Lien',
                            'name' => 'citeo_partenaire_link',
                            'type' => 'url',
                            'instructions' => '',
                            'required' => 0,
                            'conditional_logic' => 0,
                        ...
                        array (
                            'key' => 'field_55ae45feac4b2',
                            'label' => 'Image du logo',
                            'name' => 'citeo_partenaire_logo',
                            'type' => 'image',
                            'instructions' => '',
                            'required' => 0,
                            'conditional_logic' => 0,
...
acf_add_local_field_group(array (
    'key' => 'carte-page-daccueil',
    'title' => 'Carte page d\'accueil',
    'fields' => array (
        array (
            'key' => 'field_55b0db515bf73',
            'label' => 'Elements à faire figurer sur la carte',
            'name' => 'citeo_interactive_map',
            'type' => 'taxonomy',
            'instructions' => '',
            'required' => 0,
            'conditional_logic' => 0,
