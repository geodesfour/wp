                        ...
                        <?php else: ?>
                            ...
                            <?php foreach ($groupes as $key => $groupe): ?>
                                <?php
                                    ...
                                    $elus = new WP_Query( $args );
                                    $resultats_count = $elus->found_posts;
                                ?>
                                <?php if ($elus->have_posts()) : ?>
               
                                    <div class="col-lg-12 ">        
                                    <h2 class="" id="<?=$term->slug ?>"><?php echo $groupe->name; ?> <small><?=$resultats_count; ?> élu<?php if($resultats_count > 1): ?>s<?php endif; ?></small></h2>
                                    </div>
