<?php $slides = get_field( "carrousel" ); ?>
<?php if ($slides): ?>
    ...
    <div class="section-slideshow">
        ...
        <div class="owl-carousel owl-carousel-large"<?php if(count($slides) == 1): ?> data-loop="false"<?php endif; ?> data-dots="true" data-ride="owl-carousel" data-autoplay="true" data-autoplay-timeout="4500">
